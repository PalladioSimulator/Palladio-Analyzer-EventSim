...
//
////		PCMModel model = (PCMModel) ctx.getProperties().get("model");
...
//		PCMModel pcmModel = simConfig.getPCMModel();// PCMModel.loadFromBundle(this.bundleContext.getBundle(), usageModelLocation, allocationModelLocation);
//

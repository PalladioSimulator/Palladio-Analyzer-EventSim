...
/**
 * Provides a mechanism to convert technical strings (e.g. QUEUE_LENGTH) to a
 * more readable string (e.g. queue length) which will be displayed on GUI.
 * 
...
public final class GUIStrings {
	 ...
	 * @param guiStrings
	 *            Map with available GUI strings (e.g.
	 *            {@link GUIStrings#metrics}).
	 * @param technicalName
	 *            Technical name of the GUI string.
	 * @return GUI string which belongs to the technical name.
	 */
	public static <T> String getGUIString(final Map<T, String> guiStrings,
			final T technicalName) {
	...
	/**
	 * Get the strings of a list of technical names which should be displayed on
	 * GUI.
	 * 
	 * @param <T>
	 *            Type of technical name (e.g. String or {@link DiagramType}).
	 ...
	 */
	public static <T> String[] getGUIStrings(final Map<T, String> guiStrings,
			final List<T> listOfTechnicalNames) {
	 ...
	 * @return Technical name as String or {@code null} if no technical name was
	 *         found.
	 */
	public static <T> T getTechnicalName(final Map<T, String> guiStrings,
			final String guiString) {

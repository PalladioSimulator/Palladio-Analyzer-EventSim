...
public class RCommandExportDialog extends Dialog {
    ...
    public Object open() {
        ...
        shlTest.setLocation(parent.getBounds().x + (parent.getBounds().width - shlTest.getBounds().width) / 2,
                parent.getBounds().y + (parent.getBounds().height - shlTest.getBounds().height) / 2);

        Label lblTheFollowingR = new Label(shlTest, SWT.NONE);
        lblTheFollowingR.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
        lblTheFollowingR.setText("The following R command was used to plot the diagram:");

        Button btnCopyToClipboad = new Button(shlTest, SWT.NONE);
        btnCopyToClipboad.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
        ...
        rCommand.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));

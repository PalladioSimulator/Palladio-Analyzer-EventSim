 ...
 * 
 */
public class BranchTraversalStrategy extends DecoratingTraversalStrategy<AbstractUserAction, Branch, User, UserState> {
    ...
    public ITraversalInstruction<AbstractUserAction, UserState> traverse(final Branch branch, final User user,
        ...
        traverseDecorated(branch, user, state);
        ...
        // fail if branch probabilities don't sum up to one (approximately, as determined by
        // tolerance)

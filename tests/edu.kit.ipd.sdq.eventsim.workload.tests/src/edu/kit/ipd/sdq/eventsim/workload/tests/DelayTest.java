...
public class DelayTest {
	...
	@Test
	public void delaysDontCauseContention_oneUsageScenario_twoConcurrentUsersTest() {
	...
	@Test
	public void delaysDontCauseContention_twoUsageScenarios_oneUserPerScenarioTest() {
		// create PCM usage model
		BuildingContext ctx = new BuildingContext();
		UsageBuilder ub = ctx.newUsageModel();
		UsageModel um = ub.build();
